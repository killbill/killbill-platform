...
public class DefaultPluginJavaConfig extends DefaultPluginConfig implements PluginJavaConfig {
    ...
    public DefaultPluginJavaConfig(final String pluginKey, final String pluginName, final String version, final File pluginVersionRoot, final Properties props, final boolean isVersionTostartLink, final boolean isDisabled) throws PluginConfigException {
