...
CREATE INDEX notifications_tenant_search_key ON notifications(search_key2, search_key1);
...
CREATE INDEX bus_events_tenant_search_key ON bus_events(search_key2, search_key1);
